...
public class LMSwipeToDeleteCallback extends ItemTouchHelper.SimpleCallback {

    private LessonManagementRecyclerViewAdapter mAdapter;
    ...
    public LMSwipeToDeleteCallback(Context context, LessonManagementRecyclerViewAdapter adapter, RecyclerView recyclerView) {
